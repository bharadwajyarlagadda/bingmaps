...
class QueryParameters(Schema):
    ...
    Data Fields for query schema:
        adminDistrict (str): A string that contains a subdivision, such as the
        ...
        include (str): The only value for this parameter is ciso2. When you
                       specify include=ciso2, the two-letter ISO country code
                       is included for addresses in the response.
    ...
    def build_query_string(self, data):
        ...
        Returns:
            str: query string consisting of all the values concatenated with &
        """
        query_params = []
